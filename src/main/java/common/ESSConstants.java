...
public class ESSConstants {
        ...
        {
            {
                ...
                put("HT", "HT");
                put("MB", "MB");
                put("Match-HDP","Match-HDP");// Cricket market type
                put("1x2","1x2");// Cricket market type
    ...
    public static class RolePage {
        ...
        public final static List<String> ROLE_LIST = Arrays.asList("Administrator","Agent","Cricket Trader","Direct Agent","IT Support","Soccer Trader");
    }
