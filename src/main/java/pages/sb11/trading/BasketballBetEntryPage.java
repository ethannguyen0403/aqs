...
public class BasketballBetEntryPage extends WelcomePage {
    ...
    public int findColumnIndexOfBetType(String typeName, String teamName){
        List<String> headerList = tblBasketball.getHeaderNameOfRows();
        int indexTeamPlaceBet, indexBetType = -1;
       ...
       switch (typeName.toUpperCase()){
           case "1X2":
           case "HDP":
               return indexTeamPlaceBet = teamName.equalsIgnoreCase("Home") ? indexBetType + 1 : indexBetType + 2;
           case "TOTAL POINTS":
               return indexTeamPlaceBet = teamName.equalsIgnoreCase("Over") ? indexBetType + 1 : indexBetType + 2;
           default:
    ...
    public BasketballBetSlipPopup openBetSlip(String typeName, String teamName, String eventName){
        int indexColLabel = findColumnIndexOfBetType(typeName, teamName);
    ...
    public void placeBet(Order order, String typeName, String teamName) {
        BasketballBetSlipPopup betSlipPopup = this.openBetSlip(typeName, teamName, order.getEvent().getHome());
