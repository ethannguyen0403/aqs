...
public class TrialBalanceTest extends BaseCaseAQS {
    ...
    public void Trial_Balance_C2773() throws IOException {
        ...
        String fromDay = DateUtils.getDate(0, "dd/MM/yyyy", GMT_7);
        String transType = "Payment Other";
        String desc = "TC_2773 Automation test: Transaction " + DateUtils.getMilliSeconds();
        ...
        welcomePage.waitSpinnerDisappeared();
        JournalReportsUtils.tickAuthorize(fromDay, fromDay, "Ledger", LEDGER_ASSET_DEBIT_NAME, transType, desc);
        try {
            ...
            String remarkTXN = "Automation Testing Transaction Ledger: Post-condition for txn";
            ...
            JournalReportsUtils.tickAuthorize(fromDay, fromDay, "Ledger", LEDGER_ASSET_DEBIT_NAME, "Received Comm/Rebate", remarkTXN);
            log("INFO: Executed completely");
        }
    }
    ...
    public void Trial_Balance_C21832() throws IOException {
        ...
        String transType = "Payment Other";
        String desc = "TC_21832 Automation test: Transaction " + DateUtils.getMilliSeconds();
        Transaction transaction = new Transaction.Builder()
        ...
        try {
            ...
            welcomePage.waitSpinnerDisappeared();
            JournalReportsUtils.tickAuthorize(fromDate, fromDate, "Ledger", LEDGER_ASSET_DEBIT_NAME, transType, desc);
            log("Pre-condition 2: Get value of debit/credit that will display in trial balance");
            LedgerStatementPage ledgerStatementPage = welcomePage.navigatePage(GENERAL_REPORTS, LEDGER_STATEMENT, LedgerStatementPage.class);
            ledgerStatementPage.waitSpinnerDisappeared();
            ledgerStatementPage.showLedger(KASTRAKI_LIMITED, financialYear, "Asset", parentDebit, firstDayOfMonth, lastDayOfMonth, "");
            String valueDeEx = ledgerStatementPage.getGrandTotalByRunningBal("CUR Translation");

            ledgerStatementPage.showLedger(KASTRAKI_LIMITED, financialYear, "Asset", ledgerNega, firstDayOfMonth, lastDayOfMonth, "");
            ...
            page.filter(KASTRAKI_LIMITED, financialYear, monthFilter, "");
            ...
            welcomePage.waitSpinnerDisappeared();
            log("@Post-condition: authorize transaction");
            JournalReportsUtils.tickAuthorize(fromDate, fromDate, "Ledger", LEDGER_ASSET_DEBIT_NAME, "Received Comm/Rebate", remarkTXN);
            log("INFO: Executed completely");
        }
    }
    ...
    public void Trial_Balance_C21833() throws IOException {
        ...
        String financialYear = welcomePage.pickFinancialYear(FINANCIAL_YEAR);
        String transType = "Payment Other";
        String desc = "TC_21833 Automation test: Transaction " + DateUtils.getMilliSeconds();
        Transaction transaction = new Transaction.Builder()
        ...
        try {
            ...
            welcomePage.waitSpinnerDisappeared();
            JournalReportsUtils.tickAuthorize(fromDate, fromDate, "Ledger", LEDGER_EXPENDITURE_DEBIT_NAME, transType, desc);
            log("Pre-condition 2: Get value of debit/credit that will display in trial balance");
            LedgerStatementPage ledgerStatementPage = welcomePage.navigatePage(GENERAL_REPORTS, LEDGER_STATEMENT, LedgerStatementPage.class);
            ledgerStatementPage.waitSpinnerDisappeared();
            ledgerStatementPage.showLedger(KASTRAKI_LIMITED, financialYear, "Expenditure", parentDebit, firstDayOfMonth, lastDayOfMonth, "");
            String valueDeEx = ledgerStatementPage.getGrandTotalByRunningBal("CUR Translation");

            ledgerStatementPage.showLedger(KASTRAKI_LIMITED, financialYear, "Expenditure", ledgerNega, firstDayOfMonth, lastDayOfMonth, "");
            String valueCreEx = ledgerStatementPage.getGrandTotalByRunningBal("CUR Translation");
            log("@Step 1: Access SB11 > Financial Reports > Trial Balance");
            TrialBalancePage page = welcomePage.navigatePage(FINANCIAL_REPORTS, TRIAL_BALANCE, TrialBalancePage.class);
            log("@Step 2: Filter with Month that is having data");
            ...
            welcomePage.waitSpinnerDisappeared();
            log("@Post-condition: authorize transaction");
            JournalReportsUtils.tickAuthorize(fromDate, fromDate, "Ledger", LEDGER_EXPENDITURE_DEBIT_NAME, "Received Comm/Rebate", remarkTXN);
            log("INFO: Executed completely");
        }
    }
    ...
    public void Trial_Balance_C21834() throws IOException {
        ...
        String financialYear = welcomePage.pickFinancialYear(FINANCIAL_YEAR);
        String transType = "Payment Other";
        String desc = "TC_21834 Automation test: Transaction " + DateUtils.getMilliSeconds();
        Transaction transaction = new Transaction.Builder()
                .ledgerCredit(ledgerAccNegaName).ledgerCreditNumber(ledgerAccNegaNum)
        ...
        try {
            ...
            welcomePage.waitSpinnerDisappeared();
            JournalReportsUtils.tickAuthorize(fromDate, fromDate, "Ledger", LEDGER_LIABILITY_DEBIT_NAME, transType, desc);
            log("Pre-condition 2: Get value of debit/credit that will display in trial balance");
            LedgerStatementPage ledgerStatementPage = welcomePage.navigatePage(GENERAL_REPORTS, LEDGER_STATEMENT, LedgerStatementPage.class);
            ledgerStatementPage.waitSpinnerDisappeared();
            ledgerStatementPage.showLedger(KASTRAKI_LIMITED, financialYear, "Liability", LEDGER_GROUP_NAME_LIABILITY, firstDayOfMonth, lastDayOfMonth, "");
            String valueDeEx = ledgerStatementPage.getGrandTotalByRunningBal("CUR Translation");

            ledgerStatementPage.showLedger(KASTRAKI_LIMITED, financialYear, "Liability", ledgerNega, firstDayOfMonth, lastDayOfMonth, "");
            String valueCreEx = ledgerStatementPage.getGrandTotalByRunningBal("CUR Translation");
            log("@Step 1: Access SB11 > Financial Reports > Trial Balance");
            TrialBalancePage page = welcomePage.navigatePage(FINANCIAL_REPORTS, TRIAL_BALANCE, TrialBalancePage.class);
            log("@Step 2: Filter with Month that is having data");
            ...
            welcomePage.waitSpinnerDisappeared();
            log("@Post-condition: authorize transaction");
            JournalReportsUtils.tickAuthorize(fromDate, fromDate, "Ledger", LEDGER_LIABILITY_DEBIT_NAME, "Received Comm/Rebate", remarkTXN);
            log("INFO: Executed completely");
        }
    }
    ...
    public void Trial_Balance_C21835() throws IOException {
        ...
        String financialYear = welcomePage.pickFinancialYear(FINANCIAL_YEAR);
        String transType = "Payment Other";
        String desc = "TC_21835 Automation test: Transaction " + DateUtils.getMilliSeconds();
        Transaction transaction = new Transaction.Builder()
        ...
        try {
            ...
            welcomePage.waitSpinnerDisappeared();
            JournalReportsUtils.tickAuthorize(fromDate, fromDate, "Ledger", LEDGER_CAPITAL_CREDIT_NAME, transType, desc);
            log("Pre-condition 2: Get value of debit/credit that will display in trial balance");
            LedgerStatementPage ledgerStatementPage = welcomePage.navigatePage(GENERAL_REPORTS, LEDGER_STATEMENT, LedgerStatementPage.class);
            ledgerStatementPage.waitSpinnerDisappeared();
            ledgerStatementPage.showLedger(KASTRAKI_LIMITED, financialYear, "Capital", parentDebit, firstDayOfMonth, lastDayOfMonth, "");
            String valueDeEx = ledgerStatementPage.getGrandTotalByRunningBal("CUR Translation");

            ledgerStatementPage.showLedger(KASTRAKI_LIMITED, financialYear, "Capital", ledgerNega, firstDayOfMonth, lastDayOfMonth, "");
            String valueCreEx = ledgerStatementPage.getGrandTotalByRunningBal("CUR Translation");
            log("@Step 1: Access SB11 > Financial Reports > Trial Balance");
            TrialBalancePage page = welcomePage.navigatePage(FINANCIAL_REPORTS, TRIAL_BALANCE, TrialBalancePage.class);
            log("@Step 2: Filter with Month that is having data");
            String monthFilter = DateUtils.getMonthYear(GMT_7, -1, "yyyy - MMMM");
            page.filter(KASTRAKI_LIMITED, financialYear, monthFilter, "");
            String valueDeAc = page.getAmountValue(ChartOfAccountUtils.getAccountNumber(parentDebit, true), page.colDeCurrentMonth).equals("0.00") ?
                    page.getAmountValue(ChartOfAccountUtils.getAccountNumber(parentDebit, true), page.colCreCurrentMonth) : page.getAmountValue(ChartOfAccountUtils.getAccountNumber(parentDebit, true), page.colDeCurrentMonth);
            String valueCreAc = page.getAmountValue(ChartOfAccountUtils.getAccountNumber(ledgerNega, true), page.colDeCurrentMonth).equals("0.00") ?
                    page.getAmountValue(ChartOfAccountUtils.getAccountNumber(ledgerNega, true), page.colCreCurrentMonth) : page.getAmountValue(ChartOfAccountUtils.getAccountNumber(ledgerNega, true), page.colDeCurrentMonth);
            log("@Verify 1: The amount is positive, display it in Debit");
            Assert.assertEquals(valueDeAc, valueDeEx, "FAILED! Value Debit display incorrect");
            log("@Verify 2: The amount is negative, display it in Credit");
            Assert.assertEquals(valueCreAc, valueCreEx, "FAILED! Value Debit display incorrect");
    ...
    public void Trial_Balance_C21836() throws IOException {
        ...
        String financialYear = welcomePage.pickFinancialYear(FINANCIAL_YEAR);
        String transType = "Payment Other";
        String desc = "TC_21836 Automation test: Transaction " + DateUtils.getMilliSeconds();
        Transaction transaction = new Transaction.Builder()
                .ledgerCredit(ledgerAccNegaName).ledgerCreditNumber(ledgerAccNegaNum)
        ...
        try {
            ...
            welcomePage.waitSpinnerDisappeared();
            JournalReportsUtils.tickAuthorize(fromDate, fromDate, "Ledger", LEDGER_INCOME_DEBIT_NAME, transType, desc);
            log("Pre-condition 2: Get value of debit/credit that will display in trial balance");
            LedgerStatementPage ledgerStatementPage = welcomePage.navigatePage(GENERAL_REPORTS, LEDGER_STATEMENT, LedgerStatementPage.class);
            ledgerStatementPage.waitSpinnerDisappeared();
            ledgerStatementPage.showLedger(KASTRAKI_LIMITED, financialYear, "Income", LEDGER_GROUP_NAME_INCOME, firstDayOfMonth, lastDayOfMonth, "Before CJE");
            String valueDeEx = ledgerStatementPage.getGrandTotalByRunningBal("CUR Translation");
            ledgerStatementPage.showLedger(KASTRAKI_LIMITED, financialYear, "Income", ledgerNega, firstDayOfMonth, lastDayOfMonth, "");
            String valueCreEx = ledgerStatementPage.getGrandTotalByRunningBal("CUR Translation");
            log("@Step 1: Access SB11 > Financial Reports > Trial Balance");
            TrialBalancePage page = welcomePage.navigatePage(FINANCIAL_REPORTS, TRIAL_BALANCE, TrialBalancePage.class);
            log("@Step 2: Filter with Month that is having data");
            String monthFilter = DateUtils.getMonthYear(GMT_7, -1, "yyyy - MMMM");
            page.filter(KASTRAKI_LIMITED, financialYear, monthFilter, "");
            String valueDeAc = page.getAmountValue(ChartOfAccountUtils.getChartCode(ChartOfAccountUtils.getAccountName(parentDebit, true)), page.colDeCurrentMonth).equals("0.00") ?
                    page.getAmountValue(ChartOfAccountUtils.getChartCode(ChartOfAccountUtils.getAccountName(parentDebit, true)), page.colCreCurrentMonth) : page.getAmountValue(ChartOfAccountUtils.getChartCode(ChartOfAccountUtils.getAccountName(parentDebit, true)), page.colDeCurrentMonth);
            String valueCreAc = page.getAmountValue(ChartOfAccountUtils.getChartCode(ChartOfAccountUtils.getAccountName(ledgerNega, true)), page.colDeCurrentMonth).equals("0.00") ?
                    page.getAmountValue(ChartOfAccountUtils.getChartCode(ChartOfAccountUtils.getAccountName(ledgerNega, true)), page.colCreCurrentMonth) : page.getAmountValue(ChartOfAccountUtils.getChartCode(ChartOfAccountUtils.getAccountName(ledgerNega, true)), page.colDeCurrentMonth);
            log("@Verify 1: The amount is positive, display it in Debit");
            Assert.assertEquals(valueDeAc, valueDeEx, "FAILED! Value Debit display incorrect");
            log("@Verify 2: The amount is negative, display it in Credit");
            Assert.assertEquals(valueCreAc, valueCreEx, "FAILED! Value Debit display incorrect");
            ...
            welcomePage.waitSpinnerDisappeared();
            log("@Post-condition: authorize transaction");
            JournalReportsUtils.tickAuthorize(fromDate, fromDate, "Ledger", LEDGER_INCOME_DEBIT_NAME, "Received Comm/Rebate", remarkTXN);
            log("INFO: Executed completely");
        }
    }
