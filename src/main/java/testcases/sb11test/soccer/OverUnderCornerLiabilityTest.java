...
public class OverUnderCornerLiabilityTest extends BaseCaseAQS {
    ...
    public void OverUnderCornerLiabilityTC_2119(){
        ...
        Assert.assertEquals(overUnderCornerLiabilityPage.ddpCompanyUnit.getOptions(),COMPANY_UNIT_LIST_ALL,"Failed! Company Unit dropdown is not displayed");
        ...
        Assert.assertEquals(overUnderCornerLiabilityPage.lblShowBetType.getText(),"Show Bet Types\nAll","Failed! Show Bet Types button is not displayed");
        Assert.assertEquals(overUnderCornerLiabilityPage.lblShowLeagues.getText(), "Show Leagues\nAll","Failed! Show Leagues button is not displayed");
        Assert.assertEquals(overUnderCornerLiabilityPage.lblShowGroups.getText(),"Show Groups\nAll","Failed! Show Groups button is not displayed");
        Assert.assertEquals(overUnderCornerLiabilityPage.lblShowEvents.getText(),"Show Events\nAll","Failed! Show Events button is not displayed");
