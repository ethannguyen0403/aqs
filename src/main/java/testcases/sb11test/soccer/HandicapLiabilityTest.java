...
public class HandicapLiabilityTest extends BaseCaseAQS {
    ...
    public void HandicapLiabilityTC_2110(){
        ...
        Assert.assertEquals(handicapLiabilityPage.ddpCompanyUnit.getOptions(),COMPANY_UNIT_LIST_ALL,"Failed! Company Unit dropdown is not displayed");
        ...
        Assert.assertEquals(handicapLiabilityPage.lblShowBetType.getText(),"Show Bet Types\nAll","Failed! Show Bet Types button is not displayed");
        Assert.assertEquals(handicapLiabilityPage.lblShowLeagues.getText(), "Show Leagues\nAll","Failed! Show Leagues button is not displayed");
        Assert.assertEquals(handicapLiabilityPage.lblShowGroups.getText(),"Show Groups\nAll","Failed! Show Groups button is not displayed");
        Assert.assertEquals(handicapLiabilityPage.lblShowEvents.getText(),"Show Events\nAll","Failed! Show Events button is not displayed");
