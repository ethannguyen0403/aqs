...
public class SPPTest extends BaseCaseAQS {
    ...
    @TestRails(id = "1002")
    public void SPPTC_1002(String accountCode, String smartGroup, String superCode,String clientCode,String agentCode){
    ...
    @TestRails(id = "311")
    public void SPPTC_311(String bookieCode, String accountCode, String accountCurrency,String bookieMasterCode,String smartGroup)  {
        ...
        String winlosePlayer = bookieStatementPage.getMemberSummary(bookieMasterCode,accountCode).get(7);
