...
public class LedgerStatementTest extends BaseCaseAQS {
    ...
    String debitAstAcc = "AutoExpenditureDebit";
    String creditAstAcc = "AutoExpenditureCredit";
    ...
    public void Bet_Entry_TC841(){
        ...
        Transaction transaction = new Transaction.Builder()
                ...
                .amountDebit(1)
                .amountCredit(1)
                .remark("Automation Testing Transaction Ledger Expenditure")
                .transDate("")
                .transType(transType)
                .build();
    ...
    public void Bet_Entry_TC845(){
        ...
        Transaction transaction = new Transaction.Builder()
                ...
                .amountDebit(1)
                .amountCredit(1)
                .remark("Automation Testing Transaction Ledger Asset")
                .transDate("")
                .transType(transType)
                .build();
        log("@Step 4: Input Amount for Debit and Credit (should be same e.g 10)");
